...
def build_rangevit_model(settings, pretrained_path=None):
    model = models.RangeViT(
        ...
        use_geometry_fusion=settings.use_geometry_fusion,
        geometry_fusion_channels=settings.geometry_fusion_channels)
    return model
...
class Experiment(object):
    def __init__(self, settings: Option):
        ...
        tools.dist_barrier()  # no-op when running single-process
