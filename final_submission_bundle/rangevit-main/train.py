...
class Trainer(object):
    ...
    def _initDataloader(self):
        ...
        # SemanticKitti dataset
            ...
            if self.settings.use_in_domain_split:
                print('Train/val split within train sequences.')
                trainset = dataset.semantic_kitti.SemanticKitti(
                    root=self.settings.data_root,
                    sequences=train_sequences,
                    config_path=data_config_path,
                    split='train',
                    split_ratio=self.settings.in_domain_split_ratio,
                    split_seed=self.settings.seed)
            else:
                trainset = dataset.semantic_kitti.SemanticKitti(
                    root=self.settings.data_root,
                    sequences=train_sequences,
